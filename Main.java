...
public class CoffeeMachine {
    ...
    enum Status{
        CHOOSING, BUYING, EXITING, REMAINING, TAKING, FILLING;
    }
    
    static Status onStatus = Status.CHOOSING;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (action) {
                case "buy":
                    onStatus = Status.BUYING;
                    
                    buy();
                    break;
                case "fill":
                    onStatus = Status.FILLING;
                    fill();
                    break;
                case "take":
                    onStatus = Status.TAKING;
                    take();
                    break;
                case "remaining":
                    onStatus = Status.REMAINING;
                    remaining();
                    break;
                case "exit":
                    exit();
